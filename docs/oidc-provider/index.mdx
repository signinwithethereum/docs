...
<FullWidthLink
	...
	logo='/img/github.svg'
	text='signinwithethereum/oidc-provider'
	themeAware={true}
/>
...
- [API Reference](api-reference) — endpoints, scopes, claims, and token TTLs
- [Deployment Guide](deployment-guide) — Docker Compose, environment variables, production checklist
- [Client Setup](client-setup) — reference client implementation and building your own
