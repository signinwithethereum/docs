...
The TypeScript implementation is available on npm and provides comprehensive [EIP-4361](../general-information/eip-4361-specification.md) support.
...
-   Implements [EIP-4361](../general-information/eip-4361-specification.md): Sign In With Ethereum
-   Provides TypeScript library for SIWE functionality
-   Supports frontend and backend integration

### Additional Resources

-   [Quickstart Guide](/quickstart)
-   [Migrating to v2](/languages/typescript/migrating-to-v2)
-   [TypeScript Quickstart](/languages/typescript/typescript-quickstart)
...
| `version`        | `string`   | ✅       | Must be `"1"` for [EIP-4361](../general-information/eip-4361-specification.md) compliance |
...
Formats the SIWE message according to [EIP-4361](../general-information/eip-4361-specification.md) specification.
...
-   **npm**: [https://www.npmjs.com/package/siwe](https://www.npmjs.com/package/siwe)
